...
//      permission check
        ...
        mSpinTime.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (tim.equals("Select time")) {
                    Toast.makeText(FindLocation.this, "Please Select time!", Toast.LENGTH_SHORT).show();
                }
                if (tim == "5 sec") {
                    tim = String.valueOf(tim.charAt(0));
                    Toast.makeText(FindLocation.this, tim + "", Toast.LENGTH_SHORT).show();
                }
                if (tim == "10 sec") {
    ...
    private void enable_button() {
        ...
        mLocationBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                gps = new GPS_Service(FindLocation.this, tim);
                startService(new Intent(FindLocation.this, GPS_Service.class));
                ...
                if (gps.canGetLocation()) {
                    ...
                    Toast.makeText(FindLocation.this, latitude + " ::: " + longitude, Toast.LENGTH_SHORT).show();
                } else {
    ...
    private boolean runtime_permission() {
        if (Build.VERSION.SDK_INT >= 23 && ContextCompat.checkSelfPermission(FindLocation.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(FindLocation.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
